...
namespace ly
{
	...
	{
	public:
		ValueGuage(const sf::Vector2f& size = sf::Vector2f{ 230.f, 40.f },
			float initialPercent = 0.75,
			sf::Color foregroundColor = sf::Color{ 128,255,128,255 },
			sf::Color backgroundColor = sf::Color{ 128,128,128,255 });
